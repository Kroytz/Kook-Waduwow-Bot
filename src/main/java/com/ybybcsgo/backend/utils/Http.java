...
public class Http {
    ...
    public static String getHtmlByGet(String urlString, String param) throws IOException {
        byte[] xmlData = param.getBytes("UTF-8");

        //接收想要连接网址的地址
        String urlStringWithParam = urlString + "?" + param;
        System.out.printf("[Http] [getHtmlByGet] Request url = %s\n", urlStringWithParam);
        URL url = new URL(urlStringWithParam);
        //响应
